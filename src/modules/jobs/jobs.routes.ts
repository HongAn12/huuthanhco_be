...
// Admin
jobsRouter.post("/", requireAuth, requirePermission("recruitment:write"), asyncHandler(async (req, res) => {
...
jobsRouter.put("/:id", requireAuth, requirePermission("recruitment:write"), asyncHandler(async (req, res) => {
...
jobsRouter.delete("/:id", requireAuth, requirePermission("recruitment:write"), asyncHandler(async (req, res) => {
